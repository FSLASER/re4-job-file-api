...
def test_get_pdf_lap(server, pass_code, device_id, pdf_file_path, json_file_path, output_file_path, device_totp_code=None, workspaceX_mm_min=0, workspaceX_mm_max=0, workspaceY_mm_min=0, workspaceY_mm_max=0):
    """
