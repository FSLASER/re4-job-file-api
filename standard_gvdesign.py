...
def test_gvdesign_lap(server, pass_code, device_access_code, gvdesign_file_path, json_file_path, output_file_path, workspace_width_mm=0, workspace_height_mm=0):
    """
