...
def test_get_standard_png_lap(server, pass_code, device_id, png_file_path, json_file_path, transform_params, output_file_path, device_totp_code=None):
    """
...
if __name__ == "__main__":
    ...
    #     test_get_standard_png_lap(server, pass_code, device_id, png_file_path, json_file_path, transform_params, "output_standard_png_with_totp.lap", device_totp_code=device_totp_code)
    # except Exception as e:
